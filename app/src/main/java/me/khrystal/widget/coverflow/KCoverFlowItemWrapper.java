 ...
 */
public class KCoverFlowItemWrapper extends ViewGroup {
    ...
    public KCoverFlowItemWrapper(Context context) {
        super(context);
        this.init();
    }

    public KCoverFlowItemWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public KCoverFlowItemWrapper(Context context, AttributeSet attrs, int defStyle) {
