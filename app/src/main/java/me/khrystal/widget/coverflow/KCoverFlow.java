 ...
 */
public class KCoverFlow extends Gallery {
    ...
    public KCoverFlow(Context context) {
        super(context);
        this.initialize();
    }

    public KCoverFlow(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initialize();
        this.applyXmlAttributes(attrs);
    }

    public KCoverFlow(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.KCoverFlow);

        this.actionDistance = a.getInteger(R.styleable.KCoverFlow_actionDistance, ACTION_DISTANCE_AUTO);
        this.scaleDownGravity = a.getFloat(R.styleable.KCoverFlow_scaleDownGravity, 1.0f);
        this.maxRotation = a.getInteger(R.styleable.KCoverFlow_maxRotation, 45);
        this.unselectedAlpha = a.getFloat(R.styleable.KCoverFlow_unselectedAlpha, 0.3f);
        this.unselectedSaturation = a.getFloat(R.styleable.KCoverFlow_unselectedSaturation, 0.0f);
        this.unselectedScale = a.getFloat(R.styleable.KCoverFlow_unselectedScale, 0.75f);
    }
    ...
    public void setReflectionRatio(float reflectionRatio) {
        ...
        if (this.getAdapter() != null) {
            ((KCoverFlowAdapter) this.getAdapter()).notifyDataSetChanged();
        }
    }
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        if (!(adapter instanceof KCoverFlowAdapter)) {
            throw new ClassCastException(KCoverFlow.class.getSimpleName() + " only works in conjunction with a " + KCoverFlowAdapter.class.getSimpleName());
        }
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        KCoverFlowItemWrapper item = (KCoverFlowItemWrapper) child;
